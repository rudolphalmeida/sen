...
std::array<Opcode, 256> OPCODES{
    {
        ...
        {OpcodeClass::JAM, 0x1, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x5, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x6, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x7, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x8, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x9, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xD, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0xE, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0xF, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x10, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x11, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x15, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x19, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x1D, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x21, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x22, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x23, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x24, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x25, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x26, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x27, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x28, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x29, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x2A, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x2B, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x2C, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x2D, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x2E, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x2F, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x30, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x31, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x35, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x39, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x3D, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x41, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x45, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x46, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x47, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x48, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x49, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x4D, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x4E, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x4F, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x50, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x51, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x55, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x59, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x5D, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x5E, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x5F, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0x60, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x68, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x70, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x81, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x85, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x8D, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x91, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x95, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x99, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0x9D, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xB8, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xC1, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xC5, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xC9, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xCD, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xD1, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xD5, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0xD6, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0xD7, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0xD8, AddressingMode::Implied, 1, 1},
        {OpcodeClass::JAM, 0xD9, AddressingMode::Implied, 1, 1},
        ...
        {OpcodeClass::JAM, 0xDD, AddressingMode::Implied, 1, 1},
